...
namespace TempSoft.CQRS.Tests.CosmosDb.Commands.CommandRegistry
{
    ...
    public class IntegrationTests
    {
        ...
        public async Task OneTimeSetUp()
        {
            ...
            _repository = new CosmosDbCommandRegistry(_client, new CosmosDbQueryPager(), Data.DatabaseId, Data.Collectionid);
        ...
        private static class Data
        {
            ...
            public static readonly Guid[] CommandIds2 = {Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid()};
        }
    }
}