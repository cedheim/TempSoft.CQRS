...
namespace TempSoft.CQRS.Tests.CosmosDb.Queries
{
    ...
    public class IntegrationTests
    {
        ...
        public async Task SetUp()
        {
            ...
            _repository = new CosmosDbQueryModelRepository(_client, new CosmosDbQueryPager(), Data.DatabaseId, Data.Collectionid);
        }
        ...
        public async Task When_saveing_a_document()
        {
            ...
            var response = await _client.ReadDocumentAsync(UriFactory.CreateDocumentUri(Data.DatabaseId, Data.Collectionid, Data.QuerModelId1));
        ...
        {
            var model = new AThingQueryModel() { A = Data.AValue1, B = Data.BValue1 };
            await _client.UpsertDocumentAsync(UriFactory.CreateDocumentCollectionUri(Data.DatabaseId, Data.Collectionid), new QueryModelPayloadWrapper(Data.QuerModelId1, model));
        ...
        public async Task When_getting_multiple_documents()
        {
            ...
            await _client.UpsertDocumentAsync(UriFactory.CreateDocumentCollectionUri(Data.DatabaseId, Data.Collectionid), new QueryModelPayloadWrapper(Data.QuerModelId1, model1));

            var model2 = new AThingQueryModel() { A = Data.AValue2, B = Data.BValue2 };
            await _client.UpsertDocumentAsync(UriFactory.CreateDocumentCollectionUri(Data.DatabaseId, Data.Collectionid), new QueryModelPayloadWrapper(Data.QuerModelId2, model2));
