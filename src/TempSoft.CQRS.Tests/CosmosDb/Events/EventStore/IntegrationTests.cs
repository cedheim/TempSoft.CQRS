...
namespace TempSoft.CQRS.Tests.CosmosDb.Events.EventStore
{
    ...
    public class IntegrationTests
    {
        ...
        public async Task OneTimeSetUp()
        {
            ...
            {
                new ChangedAValue(Data.AValue) {AggregateRootId = Data.AggregateRootId1, Version = 3, EventGroup = nameof(AThingAggregateRoot)},
                new ChangedBValue(Data.BValue) {AggregateRootId = Data.AggregateRootId1, Version = 1, EventGroup = nameof(AThingAggregateRoot)},
                new ChangedAValue(Data.AValue) {AggregateRootId = Data.AggregateRootId1, Version = 2, EventGroup = nameof(AThingAggregateRoot)},
                new ChangedAValue(Data.AValue) {AggregateRootId = Data.AggregateRootId1, Version = 0, EventGroup = nameof(AThingAggregateRoot)},
            };
            var events2 = new IEvent[]
            {
                new ChangedAValue(Data.AValue) {AggregateRootId = Data.AggregateRootId2, Version = 3, EventGroup = nameof(AThingAggregateRoot)},
                new ChangedAValue(Data.AValue) {AggregateRootId = Data.AggregateRootId2, Version = 1, EventGroup = nameof(AThingAggregateRoot)},
                new ChangedAValue(Data.AValue) {AggregateRootId = Data.AggregateRootId2, Version = 2, EventGroup = nameof(AThingAggregateRoot)},
                new ChangedBValue(Data.BValue) {AggregateRootId = Data.AggregateRootId2, Version = 0, EventGroup = nameof(AThingAggregateRoot)},
            };
            var events3 = new IEvent[]
            {
                new ChangedAValue(Data.AValue) {AggregateRootId = Data.AggregateRootId3, Version = 3, EventGroup = "AA"},
                new ChangedAValue(Data.AValue) {AggregateRootId = Data.AggregateRootId3, Version = 1, EventGroup = "AA"},
                new ChangedAValue(Data.AValue) {AggregateRootId = Data.AggregateRootId3, Version = 2, EventGroup = "AA"},
        ...
        public async Task When_listing_documents()
        {
            ...
            await _repository.List(new EventStoreFilter{ EventGroups = new string[]{ nameof(AThingAggregateRoot) }, EventTypes = new string[] { typeof(ChangedBValue).ToFriendlyName() }}, (e, token) => Task.Run(() => result.Add(e), token));
