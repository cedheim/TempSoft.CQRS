...
{
    [TestFixture]
    public class When_getting_the_status_of_an_event_stream
    {
        ...
        private EventStreamStatus _result;
        ...
        public async Task OneTimeSetUp()
        {
            ...
            _result = await _repository.GetStatusForStream(Data.EventStreamName);
        }
        ...
        {
            _result.Should().Be(_state.Status);
        }
    }
}