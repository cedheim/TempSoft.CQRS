    ...
    public class IntegrationTests
    {
        ...
        public async Task OneTimeSetUp()
        {
            ...
            _state = new CQRS.CosmosDb.Events.EventStreamState
            {
                EventCount = 5,
                Id = Data.StreamName1,
                Status = EventStreamStatus.Initializing
            };
            ...
            _repository = new CosmosDbEventStreamStateManager(_client, new CosmosDbQueryPager(), Data.DatabaseId,
                Data.Collectionid);

            await _client.UpsertDocumentAsync(
                UriFactory.CreateDocumentCollectionUri(Data.DatabaseId, Data.Collectionid), _state);
        }
