...
namespace TempSoft.CQRS.CosmosDb.Tests.Commands.CommandRegistry
{
    ...
    public class When_getting_a_command_list
    {
        ...
        public async Task OneTimeSetUp()
        {
            _commands = new[]
            {
                new CommandRegistryWrapper(Data.AggregateRootId1, Data.CommandId1),
                new CommandRegistryWrapper(Data.AggregateRootId2, Data.CommandId2)
            };
            ...
            A.CallTo(() => _pager.CreatePagedQuery(A<IQueryable<CommandRegistryWrapper>>.Ignored))
                .ReturnsLazily(foc =>
                    new MockDocumentQuery<CommandRegistryWrapper>(
                        foc.GetArgument<IQueryable<CommandRegistryWrapper>>(0)));
        ...
        {
            A.CallTo(() => _client.CreateDocumentQuery<CommandRegistryWrapper>(
                    UriFactory.CreateDocumentCollectionUri(Data.DatabaseId, Data.Collectionid), A<FeedOptions>.Ignored))
