...
namespace TempSoft.CQRS.Demo.Tests.Domain
{
    ...
    public class Bookings
    {
        ...
        public async Task SetUp()
        {
            ...
            A.CallTo(() =>
                    _fakeRouter.GetReadModel<Theatre, TheatreReadModel>(Data.Theatre, A<CancellationToken>.Ignored))
        ...
        public async Task When_creating_a_new_booking()
        {
            ...
            await root.Handle(
                new CreateBooking(Data.AggregateRootId, Data.Theatre, Data.Auditorium, Data.Slot, Data.MovieId,
                    Data.MovieVersion), CancellationToken.None);
        ...
        public void When_creating_a_new_booking_and_the_auditorium_does_not_exist()
        {
            ...
            root.Invoking(r =>
                    r.Handle(
                        new CreateBooking(Data.AggregateRootId, Data.Theatre, Guid.NewGuid(), Data.Slot, Data.MovieId,
                            Data.MovieVersion), CancellationToken.None).Wait())
        ...
        public void When_creating_a_new_booking_and_the_movie_version_does_not_exist()
        {
            ...
            root.Invoking(r =>
                    r.Handle(
                        new CreateBooking(Data.AggregateRootId, Data.Theatre, Data.Auditorium, Data.Slot, Data.MovieId,
                            Guid.NewGuid()), CancellationToken.None).Wait())
        ...
        public void When_creating_a_new_booking_and_the_slot_does_not_exist()
        {
            ...
            root.Invoking(r =>
                    r.Handle(
                        new CreateBooking(Data.AggregateRootId, Data.Theatre, Data.Auditorium, Guid.NewGuid(),
                            Data.MovieId, Data.MovieVersion), CancellationToken.None).Wait())
