...
namespace TempSoft.CQRS.Demo.Tests.Domain
{
    ...
    public class Theatres
    {
        ...
        {
            await _root.Handle(new AddAuditoriumProperty(Data.AuditoriumId, AuditoriumProperties.Is3D),
        ...
        public void When_adding_a_slot()
        {
            _commit.Events.Should().ContainSingle(e =>
                e is SlotAdded && ((SlotAdded) e).Name == Data.SlotName1 && ((SlotAdded) e).SlotId == Data.SlotId1 &&
                ((SlotAdded) e).Order == Data.Order1);
        }
        ...
        {
            _root.Invoking(r =>
                    r.Handle(new AddSlot(Data.SlotId2, Data.SlotName1, Data.Order1), CancellationToken.None).Wait())
        ...
        {
            _commit.Events.Should().ContainSingle(e =>
                e is AuditoriumAdded && ((AuditoriumAdded) e).AuditoriumId == Data.AuditoriumId &&
                ((AuditoriumAdded) e).Name == Data.AuditoriumName);
        ...
        {
            _root.Invoking(r =>
                    r.Handle(new AddAuditorium(Data.AuditoriumId, Data.AuditoriumName), CancellationToken.None).Wait())
                .Should().Throw<DuplicateAuditoriumAddedException>();
        }
        ...
        public async Task When_adding_another_slot()
        {
            ...
            commit.Events.Should().ContainSingle(e =>
                e is SlotAdded && ((SlotAdded) e).Name == Data.SlotName2 && ((SlotAdded) e).SlotId == Data.SlotId2 &&
                ((SlotAdded) e).Order == Data.Order2);
        ...
        public async Task When_adding_the_same_property_twice()
        {
            await _root.Handle(new AddAuditoriumProperty(Data.AuditoriumId, AuditoriumProperties.Is3D),
                CancellationToken.None);
            _root.Invoking(r => r.Handle(new AddAuditoriumProperty(Data.AuditoriumId, AuditoriumProperties.Is3D),
        ...
        {
            _commit.Events.Should().ContainSingle(e =>
                e is TheatreInitialized && ((TheatreInitialized) e).Name == Data.TheatreName &&
                ((TheatreInitialized) e).AggregateRootId == Data.AggregateRootId);
        ...
        public async Task When_removing_property()
        {
            await _root.Handle(new AddAuditoriumProperty(Data.AuditoriumId, AuditoriumProperties.Is3D),
                CancellationToken.None);
            await _root.Handle(new RemoveAuditoriumProperty(Data.AuditoriumId, AuditoriumProperties.Is3D),
                CancellationToken.None);
        ...
        {
            _root.Invoking(r => r.Handle(new RemoveAuditoriumProperty(Data.AuditoriumId, AuditoriumProperties.Is3D),
                    CancellationToken.None).Wait())
                .Should().Throw<AuditoriumPropertyException>();
        }
    }
