...
namespace TempSoft.CQRS.Queries
{
    public class QueryBuilderRegistry : IQueryBuilderRegistry
    {
        ...
        private readonly Dictionary<Type, List<IQueryBuilder>> _buildersByEventType =
            new Dictionary<Type, List<IQueryBuilder>>();
        ...
        public void Register(IQueryBuilder builder)
        {
            ...
            if (!_buildersByBuilderType.ContainsKey(builderType)) _buildersByBuilderType.Add(builderType, builder);
        }
